...
(3-2) You can use AperiodicityRatio_v3() if you want to use 
...
(5-2) Voice synthesis by Synthesis(), provided that AperiodicityRatio_v3() is used.
...
You can contact him via e-mail (morise@fc.ritsumei.ac.jp)
or Twitter: @m_morise
